 ...
 *
 *******************************************************************************/
package ru.dip.ui.table.actions.md;
...
public class MdExtractAction extends DocumentAction implements CancelledDocumentAction {
	...
	public void undo() throws Exception {
		...
		IDipElement oldOriginal = DdeStorage.instance.get(dipParent.getChild(tmpElment.getName()));
		...
		for (String newElementName:  fExtractResult.getCreatedElementNames()) {
			IDipElement element = DdeStorage.instance.get(dipParent.getChild(newElementName));
			if (!fHasNewTmp) {
